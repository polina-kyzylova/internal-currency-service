        ...
        <div className={styles.container}>
            <Tooltip title="Главная" placement="right">
                <button className={styles.menu_btn}>
                    <HomeIcon sx={{ color: '#808080', fontSize: icon_size }} />
                </button>
            </Tooltip>
            ...
            <Tooltip title="Моя команда" placement="right">
                <button className={styles.menu_btn}>
                    <GroupsIcon sx={{ color: '#808080', fontSize: icon_size }} />
                </button>
            </Tooltip>

            <Tooltip title="Магазин" placement="right">
                <button className={styles.menu_btn}>
                    <LocalMallIcon sx={{ color: '#808080', fontSize: icon_size }} />
                </button>
            </Tooltip>

            <Tooltip title="Активности" placement="right">
                <button className={styles.menu_btn}>
                    <RocketLaunchIcon sx={{ color: '#808080', fontSize: icon_size }} />
                </button>
            </Tooltip>

            <Tooltip title="Код-ревью" placement="right">
                <button className={styles.menu_btn}>
                    <TerminalIcon sx={{ color: '#808080', fontSize: icon_size }} />
                </button>
            </Tooltip>

            <Tooltip title="Расчет кредита" placement="right">
                <button className={styles.menu_btn}>
                    <CalculateIcon sx={{ color: '#808080', fontSize: icon_size }} />
                </button>
            </Tooltip>

            <Tooltip title="Звонки" placement="right">
                <button className={styles.menu_btn}>
                    <HeadphonesIcon sx={{ color: '#808080', fontSize: icon_size }} />
                </button>
            </Tooltip>

            <Tooltip title="Техрадар" placement="right">
                <button className={styles.menu_btn}>
                    <RadarIcon sx={{ color: '#808080', fontSize: icon_size }} />
                </button>
            </Tooltip>
        </div>
    )

                ...
                <TableBody>
                    {rows.map((row) => (
                        <TableRow key={row.name} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                            ...
                            <TableCell sx={{ fontSize: '1rem' }}>{row.calories}</TableCell>
                            <TableCell sx={{ fontSize: '1rem' }}>{row.fat}</TableCell>
                            <TableCell sx={{ fontSize: '1rem' }}>{row.carbs}</TableCell>
                            <TableCell sx={{ fontSize: '1rem' }}>{row.protein}</TableCell>
                        </TableRow>
                    ))}
                </TableBody>
            </Table>
